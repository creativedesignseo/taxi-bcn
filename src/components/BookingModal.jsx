...
export default function BookingModal({ isOpen, onClose, bookingData }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fadeIn">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100 overflow-hidden animate-slideUp">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="p-6 border-b border-gray-100">
          ...
          <div className="space-y-3 bg-gray-50 rounded-lg p-4 border border-gray-100">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs text-gray-500">{t('booking.modal.from', 'Recogida')}</p>
                <p className="text-gray-900 font-medium">{bookingData.origin.address}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs text-gray-500">{t('booking.modal.to', 'Destino')}</p>
                <p className="text-gray-900 font-medium">{bookingData.destination.address}</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 pt-2 border-t border-gray-200">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500 text-xs ml-1">({bookingData.timeEstimate} min)</span>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="relative w-[100px] flex-shrink-0">
                      <select
                        {...register('prefix')}
                        className="w-full appearance-none bg-gray-50 border border-gray-200 rounded-lg py-2 pl-2 pr-8 text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all cursor-pointer h-full text-sm"
                    ...
                    <input
                      ...
                      className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all"
                ...
                <button
                  ...
                  className="w-full text-sm text-gray-500 hover:text-yellow-600 transition-colors"
                >
